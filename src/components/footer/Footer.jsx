    ...
    return (
        <footer>
            ...
            <div className="footer__contact">
                <p>Portfolio web desarrollado con React, React Router, CSS, SASS, JavaScript, HTML y Git.</p>
                <p>2025 - DONE0424</p>
                <div className="footer__contact-links">
                    <Link to='https://github.com/AnaisCabado'>
                    ...
                    <Link to='https://www.behance.net/anascabado'>
                    ...
                    <Link to='mailto:done0424designs@gmail.com'>
