        ...
        <section id="main-info">
            ...
            <article className="main-info__biography"> {/* TODO REVISAR */}
                ...
                <div className="main-info__biography-text">
                    <h2>HOLA!</h2>
                    <p>Soy Done0424, diseñadora gráfica, ilustradora y desarrolladora UX/UI y fullstack. Me apasiona transformar ideas en experiencias visuales y digitales que conectan con las personas. </p>
